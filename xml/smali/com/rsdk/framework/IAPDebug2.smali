.class public Lcom/rsdk/framework/IAPDebug2;
...
# static fields
.field private static final LOG_TAG:Ljava/lang/String; = "IAPDebug2"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/rsdk/framework/IAPDebug2;->mContext:Landroid/content/Context;

    iput-object p0, p0, Lcom/rsdk/framework/IAPDebug2;->mAdapter:Lcom/rsdk/framework/InterfaceIAP;

    invoke-static {}, Lcom/rsdk/framework/Wrapper;->getDeveloperInfo()Ljava/util/Hashtable;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/rsdk/framework/IAPDebug2;->configDeveloperInfo(Ljava/util/Hashtable;)V

    return-void
.end method

.method static synthetic access$0(Lcom/rsdk/framework/IAPDebug2;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/rsdk/framework/IAPDebug2;->mContext:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic access$1(Lcom/rsdk/framework/IAPDebug2;Ljava/util/Hashtable;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/rsdk/framework/IAPDebug2;->getPayOrderId(Ljava/util/Hashtable;)V

    return-void
.end method

.method static synthetic access$2(Lcom/rsdk/framework/IAPDebug2;)Lcom/rsdk/framework/InterfaceIAP;
    .locals 1

    iget-object v0, p0, Lcom/rsdk/framework/IAPDebug2;->mAdapter:Lcom/rsdk/framework/InterfaceIAP;
...
.method private configDeveloperInfo(Ljava/util/Hashtable;)V
    ...
    invoke-virtual {p0, v1}, Lcom/rsdk/framework/IAPDebug2;->LogD(Ljava/lang/String;)V

    move-object v0, p1

    new-instance v1, Lcom/rsdk/framework/IAPDebug2$2;

    invoke-direct {v1, p0, v0}, Lcom/rsdk/framework/IAPDebug2$2;-><init>(Lcom/rsdk/framework/IAPDebug2;Ljava/util/Hashtable;)V
...
.method private getPayOrderId(Ljava/util/Hashtable;)V
    ...
    invoke-virtual {v0, v14}, Lcom/rsdk/framework/IAPDebug2;->LogD(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v14, v15}, Lcom/rsdk/framework/IAPDebug2;->payResult(ILjava/lang/String;)V
...
.method private payInSDK(Ljava/util/Hashtable;)V
    ...
    invoke-virtual {p0, v2}, Lcom/rsdk/framework/IAPDebug2;->LogD(Ljava/lang/String;)V

    new-instance v2, Lcom/rsdk/framework/IAPDebug2$3;

    invoke-direct {v2, p0}, Lcom/rsdk/framework/IAPDebug2$3;-><init>(Lcom/rsdk/framework/IAPDebug2;)V
    ...
    invoke-virtual {p0, v2, v0}, Lcom/rsdk/framework/IAPDebug2;->LogE(Ljava/lang/String;Ljava/lang/Exception;)V

    const/4 v2, 0x1

    const-string v3, "payInSDK error"

    invoke-virtual {p0, v2, v3}, Lcom/rsdk/framework/IAPDebug2;->payResult(ILjava/lang/String;)V
...
.method protected LogD(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/rsdk/framework/IAPDebug2;->LogE(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public getOrderId()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/rsdk/framework/IAPDebug2;->mOrderId:Ljava/lang/String;
...
.method public getPluginId()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lcom/rsdk/framework/IAPDebug2;->LogD(Ljava/lang/String;)V
...
.method public payForProduct(Ljava/util/Hashtable;)V
    ...
    new-instance v1, Lcom/rsdk/framework/IAPDebug2$1;

    invoke-direct {v1, p0, v0}, Lcom/rsdk/framework/IAPDebug2$1;-><init>(Lcom/rsdk/framework/IAPDebug2;Ljava/util/Hashtable;)V
